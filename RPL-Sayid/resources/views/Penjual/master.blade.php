    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
      ...
      <ul class="navbar-nav ml-auto">
        <li class="nav-item mr-3">
          <a href="/editProfilPen/{{$penjual['id']}}"><button type="button" class="btn btn-outline-dark"><i class="fa fa-user" aria-hidden="true"></i> {{$user['nama']}}</button></a>
        </li>
        <li class="nav-item">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              <a href="{{ url('/penjual/'.$penjual['id']) }}" class="nav-link">
